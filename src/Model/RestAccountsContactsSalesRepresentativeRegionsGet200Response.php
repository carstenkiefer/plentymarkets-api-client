...
/**
 * RestAccountsContactsSalesRepresentativeRegionsGet200Response Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RestAccountsContactsSalesRepresentativeRegionsGet200Response implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_accounts_contacts_sales_representative_regions_get_200_response';
    ...
    */
     ...
     * Sets entries
     *
     * @param object|null $entries entries
     *
     * @return $this
     */
    public function setEntries(?object $entries): static
    {
        if (is_null($entries)) {
