...
/**
 * RestAccountsAddressesContactRelationsPostRequest Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RestAccountsAddressesContactRelationsPostRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_accounts_addresses_contact_relations_post_request';
    ...
    */
     ...
     * Sets type_id
     *
     * @param int $type_id The type ID of the address. Possible values:  Invoice address = 1 Delivery address = 2
     *
     * @return $this
     */
