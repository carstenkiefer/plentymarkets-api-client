...
/**
 * VariationBarcode Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VariationBarcode implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VariationBarcode';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code The code of the variation's barcode. The combination of code and barcode ID must be unique.
     *
     * @return $this
     */
     ...
     * Sets barcode_id
     *
     * @param int|null $barcode_id The unique ID of the barcode linked to the variation. The combination of code and barcode ID must be unique.
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param string|null $created_at The time the variation's code was created.
     *
     * @return $this
     */
