...
class Listing implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the listing.
     *
     * @return $this
     */
     ...
     * Sets type_id
     *
     * @param int|null $type_id The ID of the listing type. Possible types are: <ul>     <li>1 = Auction</li>     <li>2 = Fixed</li>     <li>3 = Shop item</li> </ul>
     *
     * @return $this
     */
     ...
     *
     * @param int|null $stock_dependence_type_id The ID of the listing stock dependence. Possible stock dependence types are: <ul>     <li>1 = Unlimited with sync</li>     <li>2 = Limited with reservation</li>     <li>3 = Limited without reservation</li>     <li>4 = Unlimited without sync</li> </ul>
     *
     * @return $this
     */
     ...
     *
     * @param int|null $unit_combination_id The ID of the unit combination.
     *
     * @return $this
     */
