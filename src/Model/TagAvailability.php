...
/**
 * TagAvailability Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TagAvailability implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TagAvailability';
    ...
    */
     ...
     * Sets tag_id
     *
     * @param int|null $tag_id The Tag ID of the tag
     *
     * @return $this
     */
     ...
     * Sets tag_type
     *
     * @param string|null $tag_type The type of the tag. The following types are available. <ul> <li>blog</li> <li>category</li> <li>content_page</li> <li>variation</li> <li>ticket</li> <li>board</li> <li>order</li> </ul>
     *
     * @return $this
     */
