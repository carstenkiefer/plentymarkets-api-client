 ...
 */
class ShippingPackageType implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ShippingPackageType';
    ...
    */
     ...
     * @return $this
     */
    public function setVolumeType(?int $volume_type): static
    {
