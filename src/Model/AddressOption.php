...
/**
 * AddressOption Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AddressOption implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AddressOption';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the address option
     *
     * @return $this
     */
     ...
     * Sets type_id
     *
     * @param int|null $type_id The ID of the address option type
     *
     * @return $this
     */
