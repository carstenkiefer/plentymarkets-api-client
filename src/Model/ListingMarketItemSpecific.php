...
/**
 * ListingMarketItemSpecific Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ListingMarketItemSpecific implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ListingMarketItemSpecific';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the item specific.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $listing_market_id The LMID which belongs to the item specific ID.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the item specific.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string|null $value The value of the item specific.
     *
     * @return $this
     */
