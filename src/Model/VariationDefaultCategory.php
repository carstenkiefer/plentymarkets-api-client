...
/**
 * VariationDefaultCategory Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VariationDefaultCategory implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VariationDefaultCategory';
    ...
    */
     ...
     * Sets branch_id
     *
     * @param int|null $branch_id The unique ID of the category branch
     *
     * @return $this
     */
     ...
     * @return string|null
     */
    public function getManually(): ?string
    {
     ...
     * @return $this
     */
    public function setManually(?string $manually): static
    {
        if (is_null($manually)) {
