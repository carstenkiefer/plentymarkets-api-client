...
/**
 * SalesPriceCountry Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SalesPriceCountry implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SalesPriceCountry';
    ...
    */
     ...
     * Sets country_id
     *
     * @param int|null $country_id The unique ID of the <a href=\"https://developers.plentymarkets.com/rest-doc/introduction#countries\"  target=\"_blank\">country</a>
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param string|null $created_at The time the country was activated.
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at The time the relationship between country and sales price was last updated.
     *
     * @return $this
     */
