...
/**
 * BoardTaskReference Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class BoardTaskReference implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BoardTaskReference';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The ID of the board task reference
     *
     * @return $this
     */
     ...
     * Sets task_id
     *
     * @param string|null $task_id The ID of the task to create a reference for
     *
     * @return $this
     */
     ...
     *
     * @param string|null $reference_value Reference type followed by foreign ID of the referenced object. Syntax: TYPE-ID Example: user-123456 Types: user,ticket,contact,order,item
     *
     * @return $this
     */
