...
/**
 * PaymentContactRelation Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PaymentContactRelation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PaymentContactRelation';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the payment order relation
     *
     * @return $this
     */
     ...
     * Sets payment_id
     *
     * @param int|null $payment_id The ID of the payment
     *
     * @return $this
     */
     ...
     * Sets assigned_at
     *
     * @param string|null $assigned_at The time the payment contact relation was assigned
     *
     * @return $this
     */
    public function setAssignedAt(?string $assigned_at): static
    {
