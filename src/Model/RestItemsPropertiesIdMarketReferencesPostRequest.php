<?php
/**
 * RestItemsPropertiesIdMarketReferencesPostRequest
 *
 * PHP version 8.1
 *
...
/**
 * RestItemsPropertiesIdMarketReferencesPostRequest Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RestItemsPropertiesIdMarketReferencesPostRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_items_properties__id__market_references_post_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('external_component', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets property_id
     *
     * @param int|null $property_id The unique ID of the property optional
     *
     * @return $this
     */
     ...
     * @return $this
     */
    public function setComponentId(int $component_id): static
    {
     ...
     * @return string|null
     */
    public function getExternalComponent(): ?string
    {
     ...
     *
     * @param string|null $external_component The external reference of the property optional
     *
     * @return $this
     */
    public function setExternalComponent(?string $external_component): static
    {
        if (is_null($external_component)) {
            throw new InvalidArgumentException('non-nullable external_component cannot be null');
        }
