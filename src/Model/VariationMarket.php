...
/**
 * VariationMarket Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VariationMarket implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VariationMarket';
    ...
    */
     ...
     * Sets market_id
     *
     * @param int|null $market_id The unique ID of the market
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param string|null $created_at The time the link between the variation and the market was created.
     *
     * @return $this
     */
