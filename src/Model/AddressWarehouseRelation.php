...
/**
 * AddressWarehouseRelation Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AddressWarehouseRelation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AddressWarehouseRelation';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the address warehouse relation
     *
     * @return $this
     */
