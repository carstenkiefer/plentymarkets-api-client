...
/**
 * FeedbackRating Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class FeedbackRating implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FeedbackRating';
    ...
    */
     ...
     * Sets rating_value
     *
     * @param string|null $rating_value The value of the rating
     *
     * @return $this
     */
    public function setRatingValue(?string $rating_value): static
    {
     ...
     * Sets is_visible
     *
     * @param bool|null $is_visible If true, the rating is visible
     *
     * @return $this
     */
