...
/**
 * ListingMarketText Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ListingMarketText implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ListingMarketText';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the listing market text.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $listing_market_id The ID of the listing market the text belongs to.
     *
     * @return $this
     */
     ...
     * Sets lang
     *
     * @param string|null $lang The language of the listing market text. Available values: 'de', 'en', 'fr', 'it', 'es', 'tr', 'nl', 'pl', 'nn', 'da', 'se', 'cz', 'ru', 'sk', 'cn', 'vn', 'pt', 'bg', 'ro'.
     *
     * @return $this
     */
     ...
     * Sets title
     *
     * @param string|null $title The title of the listing market text.
     *
     * @return $this
     */
     ...
     * Sets subtitle
     *
     * @param string|null $subtitle The subtitle of the listing market text.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string|null $description The description of the listing market text.
     *
     * @return $this
     */
