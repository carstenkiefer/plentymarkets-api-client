...
/**
 * VariationDescription Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VariationDescription implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VariationDescription';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The unique ID of the description
     *
     * @return $this
     */
     ...
     * Sets item_id
     *
     * @param int|null $item_id The unique ID of the item that this description belongs to
     *
     * @return $this
     */
     ...
     * Sets lang
     *
     * @param string|null $lang The <a href=\"https://developers.plentymarkets.com/rest-doc/introduction#countries\" target=\"_blank\">language code</a> of the description
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name The default name of the item. By default, this name is displayed in the online store. For Default items, this name is also used for markets. Character limit: max. 240 characters.
     *
     * @return $this
     */
     ...
     * Sets name2
     *
     * @param string|null $name2 Alternative item name that can be used e.g. for markets. Character limit: max. 240 characters.
     *
     * @return $this
     */
     ...
     * Sets name3
     *
     * @param string|null $name3 Alternative item name that can be used e.g. for markets. Character limit: max. 240 characters.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $preview_description The preview text. The preview text is a short description that can be displayed in item lists.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $meta_description The meta description of the item. This description is analysed by search engines and displayed in search results. This text should be treated as an advertising text to maximise click-through from search engine result pages. Current recommended limit is 156 characters.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string|null $description The item description. This is a detailed description displayed in the item layout of the online store.
     *
     * @return $this
     */
     ...
     * Sets technical_data
     *
     * @param string|null $technical_data The technical data for the item. To display the technical data in the online store, insert the template variable TechnicalData and an optional title into the template ItemViewSingleItem.
     *
     * @return $this
     */
     ...
     * Sets url_path
     *
     * @param string|null $url_path The URL path of the item in the online store. By default, the URL path consists of the categories and the item name. The path will be assigned automatically by plentymarkets when the item is created and will be displayed as part of the URL when the item is selected in the online store.
     *
     * @return $this
     */
     ...
     * Sets meta_keywords
     *
     * @param string|null $meta_keywords Meta keywords to tag the item for search engines. More than one keyword can be separated by commas.
     *
     * @return $this
     */
