...
/**
 * RestReordersPostRequest Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RestReordersPostRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_reorders_post_request';
    ...
    */
     ...
     * Sets type_id
     *
     * @param int|null $type_id The ID of the order type                                                               It is possible to define individual order types. However,                                                               the following types are available by default:      1 = Sales order     2 = Delivery     3 = Returns     4 = Credit note     5 = Warranty     6 = Repair     7 = Offer     8 = Advance order     9 = Multi-order     10 = Multi credit note     11 = Multi delivery     12 = Reorder     13 = Partial delivery     14 = Subscription     15 = Redistribution  optional allowed values are 12
     *
     * @return $this
     */
