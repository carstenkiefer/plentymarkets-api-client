 ...
 */
class StorageObjectList implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'StorageObjectList';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('next_continuation_token', $data ?? [], null);
    ...
    */
     ...
     * @return $this
     */
    public function setNextContinuationToken(?string $next_continuation_token): static
    {
        if (is_null($next_continuation_token)) {
            throw new InvalidArgumentException('non-nullable next_continuation_token cannot be null');
        }
     ...
     * @return $this
     */
    public function setCommonPrefixes(?array $common_prefixes): static
    {
