...
/**
 * TaricVatAssignment Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TaricVatAssignment implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TaricVatAssignment';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the taric vat assignment
     *
     * @return $this
     */
     ...
     * Sets taric_code
     *
     * @param int|null $taric_code The taric code
     *
     * @return $this
     */
     ...
     * Sets country_id
     *
     * @param int|null $country_id The ID of the country that the taric code configuration belongs to
     *
     * @return $this
     */
     ...
     * Sets vat_field
     *
     * @param string|null $vat_field The ID of the VAT rate of the taric code / country id combination.
     *
     * @return $this
     */
