 ...
 */
class ItemSetComponent implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ItemSetComponent';
    ...
    protected static array $openAPINullables = [
		...
		'set_id' => false,
		'item_id' => false,
		'minimal_order_quantity' => false,
		'maximum_order_quantity' => false,
		'order_quantity_possible' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('minimal_order_quantity', $data ?? [], null);
        $this->setIfExists('maximum_order_quantity', $data ?? [], null);
        $this->setIfExists('order_quantity_possible', $data ?? [], null);
    }
    ...
    */
     ...
     * @return float|null
     */
    public function getMinimalOrderQuantity(): ?float
    {
     ...
     * @return $this
     */
    public function setMinimalOrderQuantity(?float $minimal_order_quantity): static
    {
        if (is_null($minimal_order_quantity)) {
            throw new InvalidArgumentException('non-nullable minimal_order_quantity cannot be null');
        }
     ...
     * @return bool|null
     */
    public function getOrderQuantityPossible(): ?bool
    {
     ...
     * @return $this
     */
    public function setOrderQuantityPossible(?bool $order_quantity_possible): static
    {
        if (is_null($order_quantity_possible)) {
            throw new InvalidArgumentException('non-nullable order_quantity_possible cannot be null');
        }
