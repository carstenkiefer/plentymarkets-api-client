...
/**
 * ContactDepartmentName Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContactDepartmentName implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ContactDepartmentName';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the contact department name
     *
     * @return $this
     */
     ...
     * Sets department_id
     *
     * @param int|null $department_id The ID of the department
     *
     * @return $this
     */
