...
/**
 * RestOrdersOrderIdPutRequest Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RestOrdersOrderIdPutRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_orders__orderId__put_request';
    ...
    */
     ...
     * Sets plenty_id
     *
     * @param int|null $plenty_id The plenty ID of the client that the order belongs to optional
     *
     * @return $this
     */
