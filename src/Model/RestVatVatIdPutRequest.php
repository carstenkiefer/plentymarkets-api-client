 ...
 */
class RestVatVatIdPutRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_vat__vatId__put_request';
    ...
    */
     ...
     * Sets vat_rate
     *
     * @param float|null $vat_rate The percentage of the VAT rate, e.g. 19.00 for 19 %
     *
     * @return $this
     */
