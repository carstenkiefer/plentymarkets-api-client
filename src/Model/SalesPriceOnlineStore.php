...
/**
 * SalesPriceOnlineStore Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SalesPriceOnlineStore implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SalesPriceOnlineStore';
    ...
    */
     ...
     * Sets plenty_id
     *
     * @param int|null $plenty_id The unique ID of the client (store)
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param string|null $created_at The time the client (store) was activated.
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at The time the relationship between the client (store) and the sales price was last updated.
     *
     * @return $this
     */
