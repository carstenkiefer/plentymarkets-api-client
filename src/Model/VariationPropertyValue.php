...
/**
 * VariationPropertyValue Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VariationPropertyValue implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VariationPropertyValue';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The unique ID of the link between the variation and the property value
     *
     * @return $this
     */
     ...
     *
     * @param int|null $property_selection_id The unique ID of the property selection of the variation
     *
     * @return $this
     */
     ...
     * Sets value_int
     *
     * @param int|null $value_int The int value of the property value of the variation
     *
     * @return $this
     */
     ...
     * Sets value_float
     *
     * @param float|null $value_float The float value of the property value of the variation
     *
     * @return $this
     */
     ...
     * Sets value_file
     *
     * @param string|null $value_file The file value of the property value of the variation
     *
     * @return $this
     */
     ...
     * Sets surcharge
     *
     * @param float|null $surcharge The surcharge of the property value of the variation
     *
     * @return $this
     */
