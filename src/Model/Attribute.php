...
class Attribute implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The unique ID of the attribute.
     *
     * @return $this
     */
     ...
     * Sets backend_name
     *
     * @param string|null $backend_name The back end name of the attribute. The name must be unique and must not contain commas, colons, semicolons or quotation marks. It is not visible in the plentymarkets front end.
     *
     * @return $this
     */
     ...
     * Sets position
     *
     * @param int|null $position The position of the attribute. Attributes are displayed in the attribute overview in ascending order by position.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $is_surcharge_percental Flag that indicates if the surcharge is percental.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $is_linkable_to_image Flag that indicates if an image can be linked to the attribute.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $amazon_attribute The attribute of the market Amazon that this attribute is liked to. To list variations on this market, attributes must be linked to one of the attributes specified by the market. Check documentation of the market for permitted values.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $fruugo_attribute The attribute of the market Fruugo that this attribute is linked to. To list variations on this market, attributes must be linked to one of the attributes specified by the market.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $pixmania_attribute The attribute of the market PIXmania that this attribute is linked to. To list variations on this market, attributes must be linked to one of the attributes specified by the market. Check documentation of the market for permitted values.
     *
     * @return $this
     */
     ...
     * Sets otto_attribute
     *
     * @param string|null $otto_attribute The attribute of the market OTTO that this attribute is linked to. To list variations on this market, attributes must be linked to one of the attributes specified by the market.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $google_shopping_attribute The attribute of the market Google Shopping that this attribute is linked to. To list variations on this market, attributes must be linked to one of the attributes specified by the market.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $neckermann_at_ep_attribute The component of the market neckermann AT EP that this attribute is linked to. To list variations on this market, attributes must be linked to one of the components specified by the market. Check documentation of the market for permitted values.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $type_of_selection_in_online_store How customers can select the attribute in the front end of a client. To allow attribute selection by check mark, attribute availability must be checked on the client side.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $la_redoute_attribute The attribute of the market La Redoute that this attribute is linked to. To list variations on this market, attributes must be linked to one of the attributes specified by the market. Check documentation of the market for permitted values.
     *
     * @return $this
     */
     ...
     * Sets is_groupable
     *
     * @param bool|null $is_groupable Flag that indicates if the attribute can be grouped in item lists. If yes, variations with this attribute can be shown in the ItemViewCategoriesList template first. Other attributes are nested and can only be selected after this attribute has been selected.
     *
     * @return $this
     */
