...
/**
 * RestItemsPropertyGroupsPostRequest Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RestItemsPropertyGroupsPostRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_items_property_groups_post_request';
    ...
    protected static array $openAPINullables = [
        'id' => false,
		'backend_name' => false,
		'order_property_grouping_type' => false,
		'is_surcharge_percental' => false,
		'otto_component_id' => false,
		'updated_at' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('order_property_grouping_type', $data ?? [], null);
        $this->setIfExists('is_surcharge_percental', $data ?? [], null);
        $this->setIfExists('otto_component_id', $data ?? [], null);
    ...
    */
     ...
     * @return $this
     */
    public function setOrderPropertyGroupingType(?string $order_property_grouping_type): static
    {
        if (is_null($order_property_grouping_type)) {
            throw new InvalidArgumentException('non-nullable order_property_grouping_type cannot be null');
        }
     ...
     * @return int|null
     */
    public function getOttoComponentId(): ?int
    {
     ...
     * @return $this
     */
    public function setOttoComponentId(?int $otto_component_id): static
    {
        if (is_null($otto_component_id)) {
            throw new InvalidArgumentException('non-nullable otto_component_id cannot be null');
        }
