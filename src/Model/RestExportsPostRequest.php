 ...
 */
class RestExportsPostRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_exports_post_request';
