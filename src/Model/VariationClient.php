...
/**
 * VariationClient Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VariationClient implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VariationClient';
    ...
    */
     ...
     * Sets created_at
     *
     * @param string|null $created_at The time at which the client (store) was linked to the variation.
     *
     * @return $this
     */
