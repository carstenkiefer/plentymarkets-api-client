...
class OrderItemProperty implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrderItemProperty';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the order item property.
     *
     * @return $this
     */
     ...
     * Sets order_item_id
     *
     * @param int|null $order_item_id The ID of the order item that the property belongs to.
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param string|null $created_at The date that the property was created.
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at The date that the property was last updated.
     *
     * @return $this
     */
