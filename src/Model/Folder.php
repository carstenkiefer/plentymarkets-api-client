...
class Folder implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the newsletter folder
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the newsletter folder
     *
     * @return $this
     */
     ...
     * Sets is_deletable
     *
     * @param bool|null $is_deletable Flag that indicates if the newsletter folder can be deleted. The folders 'Customers' and 'Interested parties' are available by default and cannot be deleted.
     *
     * @return $this
     */
     ...
     * Sets position
     *
     * @param int|null $position The position of the newsletter folder
     *
     * @return $this
     */
