...
class StorageObject implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'StorageObject';
    ...
    */
     ...
     * @return $this
     */
    public function setStorageClass(?string $storage_class): static
    {
     ...
     * Sets content_length
     *
     * @param string|null $content_length 
     *
     * @return $this
     */
