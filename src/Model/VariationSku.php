...
/**
 * VariationSku Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VariationSku implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VariationSku';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The row ID of the table plenty_item_variation_market_status
     *
     * @return $this
     */
     ...
     * Sets market_id
     *
     * @param float|null $market_id The ID of the market
     *
     * @return $this
     */
     ...
     * Sets initial_sku
     *
     * @param string|null $initial_sku The initial SKU of the variation. The initial SKU cannot be modified even if the variation SKU is changed. However, it is possible to reset the variation SKU to the initial SKU.
     *
     * @return $this
     */
     ...
     * Sets sku
     *
     * @param string|null $sku The SKU of the variation. The SKU is adjustable but may not exist twice for the combination of market Id and account Id.
     *
     * @return $this
     */
     ...
     * Sets parent_sku
     *
     * @param string|null $parent_sku The Parent SKU of the variation. The Parent SKU is adjustable. The same Parent SKU value should be used on variations of same article.
     *
     * @return $this
     */
     ...
     * Sets is_active
     *
     * @param bool|null $is_active Flag that indicates if the item is ready for export (currently not in use).
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param string|null $created_at The time the SKU was created (YYYY-MM-DD HH:MM:SS).
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at The time the SKU was updated (YYYY-MM-DD HH:MM:SS).
     *
     * @return $this
     */
     ...
     * Sets exported_at
     *
     * @param string|null $exported_at The time the variation was last exported (YYYY-MM-DD HH:MM:SS).
     *
     * @return $this
     */
     ...
     *
     * @param string|null $stock_updated_at 
     *
     * @return $this
     */
     ...
     * Sets deleted_at
     *
     * @param string|null $deleted_at The time the variation was deleted (YYYY-MM-DD HH:MM:SS).
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status The status of the variation after the export. Possible entries are INACTIVE, ERROR, SENT and ACTIVE.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $additional_information The field that contains additional information.
     *
     * @return $this
     */
