...
/**
 * TagRelationship Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TagRelationship implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TagRelationship';
    ...
    */
     ...
     * Sets tag_id
     *
     * @param int|null $tag_id The ID of the tag
     *
     * @return $this
     */
     ...
     * Sets tag_type
     *
     * @param string|null $tag_type The type of tag.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $relationship_value The ID of the data record for which a tag relationship is created
     *
     * @return $this
     */
     ...
     *
     * @param string|null $relationship_uuid5 The ID of the data record for which a tag relationship is created. For models with uuid5 as primary key
     *
     * @return $this
     */
