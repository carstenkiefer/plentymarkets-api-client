...
/**
 * VariationMarketIdentNumber Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VariationMarketIdentNumber implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VariationMarketIdentNumber';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The unique ID of the market ident number (ASIN/ePID) of a variation
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of market ident number (ASIN/ePID)
     *
     * @return $this
     */
