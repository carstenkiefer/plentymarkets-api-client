...
/**
 * RestItemsAttributesValuesMarketsMapsPostRequest Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RestItemsAttributesValuesMarketsMapsPostRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_items_attributes_values_markets_maps_post_request';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['attribute_value_id'] === null) {
            $invalidProperties[] = "'attribute_value_id' can't be null";
        }
     ...
     * Sets name
     *
     * @param string|null $name The name of the attribute value map. The name must be unique and must not contain commas, colons, semicolons or quotation marks. It is not visible in the plentymarkets front end. optional
     *
     * @return $this
     */
     ...
     *
     * @param string|null $market_information1 The information regarding the marketplace. optional
     *
     * @return $this
     */
     ...
     *
     * @param string|null $market_information2 The information regarding the marketplace. optional
     *
     * @return $this
     */
