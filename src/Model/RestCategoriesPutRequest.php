...
/**
 * RestCategoriesPutRequest Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RestCategoriesPutRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_categories_put_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('linklist', $data ?? [], null);
        ...
        $this->setIfExists('elmar_categories', $data ?? [], null);
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type The category type of the category optional allowed values are content, item, container, blog
     *
     * @return $this
     */
     ...
     * @return $this
     */
    public function setLinklist(?string $linklist): static
    {
        if (is_null($linklist)) {
            throw new InvalidArgumentException('non-nullable linklist cannot be null');
        }
     ...
     * @return $this
     */
    public function setSitemap(?string $sitemap): static
    {
        if (is_null($sitemap)) {
     ...
     * Gets details
     *
     * @return \ck/plenty-client\Model\CategoryDetails[]|null
     */
     ...
     * Sets details
     *
     * @param \ck/plenty-client\Model\CategoryDetails[]|null $details details
     *
     * @return $this
     */
     ...
     * @return $this
     */
    public function setElmarCategories(?array $elmar_categories): static
    {
        if (is_null($elmar_categories)) {
            throw new InvalidArgumentException('non-nullable elmar_categories cannot be null');
        }
