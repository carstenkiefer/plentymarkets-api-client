...
/**
 * ContactPositionName Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContactPositionName implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ContactPositionName';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the contact position name
     *
     * @return $this
     */
     ...
     * Sets position_id
     *
     * @param int|null $position_id The ID of the position
     *
     * @return $this
     */
