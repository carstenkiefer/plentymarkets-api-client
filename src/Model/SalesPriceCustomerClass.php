...
/**
 * SalesPriceCustomerClass Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SalesPriceCustomerClass implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SalesPriceCustomerClass';
    ...
    */
     ...
     *
     * @param int|null $customer_class_id The unique ID of the customer class
     *
     * @return $this
     */
    public function setCustomerClassId(?int $customer_class_id): static
    {
     ...
     * Sets created_at
     *
     * @param string|null $created_at The time the customer class was activated.
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at The time the relationship between customer class and sales price was last updated.
     *
     * @return $this
     */
