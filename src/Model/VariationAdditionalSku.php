...
/**
 * VariationAdditionalSku Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VariationAdditionalSku implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VariationAdditionalSku';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the additional sku
     *
     * @return $this
     */
     ...
     * Sets market_id
     *
     * @param float|null $market_id The ID of the market reference.
     *
     * @return $this
     */
     ...
     * Sets sku
     *
     * @param string|null $sku The additional sku for this variation.
     *
     * @return $this
     */
