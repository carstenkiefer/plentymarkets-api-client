...
/**
 * OrderShippingPackageItems Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class OrderShippingPackageItems implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OrderShippingPackageItems';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the order shipping package item. Primary key auto-increment
     *
     * @return $this
     */
     ...
     * Sets package_id
     *
     * @param int|null $package_id The ID of the package (id column from plenty_package_type2order)
     *
     * @return $this
     */
     ...
     * Sets item_id
     *
     * @param int|null $item_id The ID of the item (plenty_item_variation_base_item_id column from plenty_item_variation_base)
     *
     * @return $this
     */
     ...
     * Sets variation_id
     *
     * @param int|null $variation_id The ID of the variation (plenty_item_variation_base_id column from plenty_item_variation_base)
     *
     * @return $this
     */
     ...
     * Sets item_quantity
     *
     * @param float|null $item_quantity The quantity of the item in the package
     *
     * @return $this
     */
    public function setItemQuantity(?float $item_quantity): static
    {
