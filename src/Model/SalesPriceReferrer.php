...
/**
 * SalesPriceReferrer Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SalesPriceReferrer implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SalesPriceReferrer';
    ...
    */
     ...
     * Sets referrer_id
     *
     * @param float|null $referrer_id The unique ID of the referrer
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param string|null $created_at The time the referrer was activated.
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at The time the relationship between referrer and sales price was last updated.
     *
     * @return $this
     */
