...
/**
 * PropertyGroupName Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PropertyGroupName implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PropertyGroupName';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the property group name
     *
     * @return $this
     */
     ...
     * Sets lang
     *
     * @param string|null $lang The language of the property group name as ISO 639-1 language code, e.g. en for English
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the property group
     *
     * @return $this
     */
