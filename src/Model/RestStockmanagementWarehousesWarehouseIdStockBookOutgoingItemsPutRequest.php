 ...
 */
class RestStockmanagementWarehousesWarehouseIdStockBookOutgoingItemsPutRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_stockmanagement_warehouses__warehouseId__stock_bookOutgoingItems_put_request';
    ...
    protected static array $setters = [
        'outgoing_items' => 'setOutgoingItems',
    ...
    protected static array $getters = [
        'outgoing_items' => 'getOutgoingItems',
    ...
    {
        $this->setIfExists('outgoing_items', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['outgoing_items'];
    }
     ...
     * @return $this
     */
    public function setOutgoingItems(?array $outgoing_items): static
    {
        if (is_null($outgoing_items)) {
            throw new InvalidArgumentException('non-nullable outgoing_items cannot be null');
        }
        $this->container['outgoing_items'] = $outgoing_items;
