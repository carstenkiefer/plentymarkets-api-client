...
/**
 * VariationBundle Class Doc Comment
 *
 * @package  ck
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VariationBundle implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VariationBundle';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The unique ID of the link that marks a variation as a bundle component
     *
     * @return $this
     */
     ...
     * Sets variation_id
     *
     * @param int|null $variation_id The unique ID of the variation to which other variations are added to create a bundle
     *
     * @return $this
     */
     ...
     *
     * @param int|null $component_variation_id The unique ID of the variation added as bundle component
     *
     * @return $this
     */
     ...
     *
     * @param int|null $component_quantity The quantity of the variation to be added as bundle component
     *
     * @return $this
     */
     ...
     *
     * @param string|null $last_updated_timestamp The time the bundle was last updated.
     *
     * @return $this
     */
    public function setLastUpdatedTimestamp(?string $last_updated_timestamp): static
    {
     ...
     * Sets created_at
     *
     * @param string|null $created_at The time the bundle was created.
     *
     * @return $this
     */
