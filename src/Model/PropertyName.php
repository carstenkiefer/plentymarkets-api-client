...
class PropertyName implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PropertyName';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the property name
     *
     * @return $this
     */
     ...
     * Sets lang
     *
     * @param string|null $lang The language of the property name as ISO 639-1 language code, e.g. en for English
     *
     * @return $this
     */
