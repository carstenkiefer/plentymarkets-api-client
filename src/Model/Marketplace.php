...
class Marketplace implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets site_id
     *
     * @param int|null $site_id The ID of the site exactly as eBay specifies it in the docs. This value is/was used in the old eBay SOAP APIs
     *
     * @return $this
     */
     ...
     * Sets marketplace_id
     *
     * @param string|null $marketplace_id The ID of the marketplace exactly as eBay specifies it in the docs. This value is used in the new eBay REST APIs. Eg. `EBAY_DE` or `EBAY-DE`
     *
     * @return $this
     */
     ...
     * Sets market_id
     *
     * @param int|null $market_id System-Listing wide internal ID for the listing marketplace. This id occurs only in correlation with the listing DB tables.
     *
     * @return $this
     */
     ...
     * Sets referrer_id
     *
     * @param float|null $referrer_id System wide internal ID for the marketplace. Use this instead of `marketId` whenever possible!
     *
     * @return $this
     */
     ...
     * Sets shortcut
     *
     * @param string|null $shortcut The marketplace shortcut name.
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string|null $currency The currency used for the marketplace
     *
     * @return $this
     */
