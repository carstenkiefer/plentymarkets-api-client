<?php
/**
 * RestItemsAttributesMarketsMapsPostRequest
 *
 * PHP version 8.1
 *
...
/**
 * RestItemsAttributesMarketsMapsPostRequest Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RestItemsAttributesMarketsMapsPostRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_items_attributes_markets_maps_post_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the attribute map. The name must be unique and must not contain commas, colons, semicolons or quotation marks. It is not visible in the plentymarkets front end. optional
     *
     * @return $this
     */
