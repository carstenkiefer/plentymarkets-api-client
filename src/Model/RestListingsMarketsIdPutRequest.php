...
/**
 * RestListingsMarketsIdPutRequest Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RestListingsMarketsIdPutRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_listings_markets__id__put_request';
    ...
    */
     ...
     * Sets listing_id
     *
     * @param int|null $listing_id The listing ID of the current listing market. optional
     *
     * @return $this
     */
     ...
     *
     * @param int|null $option_template_id The ID of an existing listing option template from where to load listing market settings. @see OptionTemplate. optional
     *
     * @return $this
     */
