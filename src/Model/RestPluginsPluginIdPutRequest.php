 ...
 */
class RestPluginsPluginIdPutRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_plugins__pluginId__put_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('webstores', $data ?? [], null);
    }
    ...
    */
     ...
     * @return $this
     */
    public function setWebstores(?array $webstores): static
    {
        if (is_null($webstores)) {
            throw new InvalidArgumentException('non-nullable webstores cannot be null');
        }
