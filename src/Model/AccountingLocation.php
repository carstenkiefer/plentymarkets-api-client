...
class AccountingLocation implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AccountingLocation';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the accounting location
     *
     * @return $this
     */
     ...
     * Sets country_id
     *
     * @param int|null $country_id The ID of the country of the accounting location
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the accounting location
     *
     * @return $this
     */
     ...
     * Sets client_id
     *
     * @param int|null $client_id The ID of the client that the accounting location belongs to
     *
     * @return $this
     */
     ...
     * Sets plenty_id
     *
     * @param int|null $plenty_id The plenty ID of the client that the accounting location belongs to
     *
     * @return $this
     */
