...
/**
 * RestStockmanagementStockRedistributePutRequest Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RestStockmanagementStockRedistributePutRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_stockmanagement_stock_redistribute_put_request';
    ...
    protected static array $openAPITypes = [
        'redistributions' => '\ck/plenty-client\Model\VariationStockRedistribution[]',
        'variation_id' => 'int',
        'reason_id' => 'int',
        'quantity' => 'float',
    ...
    {
        $this->setIfExists('redistributions', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \ck/plenty-client\Model\VariationStockRedistribution[]
     */
    public function getRedistributions(): array
    {
     ...
     *
     * @param \ck/plenty-client\Model\VariationStockRedistribution[] $redistributions redistributions
     *
     * @return $this
     */
    public function setRedistributions(array $redistributions): static
    {
        if (is_null($redistributions)) {
            throw new InvalidArgumentException('non-nullable redistributions cannot be null');
        }
