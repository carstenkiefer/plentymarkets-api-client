...
class Account implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets number
     *
     * @param string|null $number The number of the account
     *
     * @return $this
     */
     ...
     * Sets tax_id_number
     *
     * @param string|null $tax_id_number The ID of the tax number
     *
     * @return $this
     */
     ...
     * Sets valuta
     *
     * @param int|null $valuta The valuta date in days specified for the account
     *
     * @return $this
     */
     ...
     *
     * @param int|null $sales_representative_contact_id The contact ID of the sales representative
     *
     * @return $this
     */
     ...
     * Sets user_id
     *
     * @param int|null $user_id The ID of the account owner
     *
     * @return $this
     */
     ...
     * Sets delivery_time
     *
     * @param int|null $delivery_time The delivery time for the supplier
     *
     * @return $this
     */
     ...
     *
     * @param float|null $dealer_min_order_value The minimum order value for the supplier
     *
     * @return $this
     */
     ...
     *
     * @param string|null $supplier_currency The currency used by a supplier
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param string|null $created_at The time the account was created as unix timestamp
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at The time the account was last updated as unix timestamp
     *
     * @return $this
     */
