<?php
/**
 * RestTagsRelationshipsPostRequest
 *
 * PHP version 8.1
 *
...
/**
 * RestTagsRelationshipsPostRequest Class Doc Comment
 *
 * @package  ck/plenty-client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RestTagsRelationshipsPostRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_rest_tags_relationships_post_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('relationship_value', $data ?? [], null);
        $this->setIfExists('relationship_uuid5', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['relationship_value'] === null) {
            $invalidProperties[] = "'relationship_value' can't be null";
        }
     ...
     * Sets tag_type
     *
     * @param string $tag_type The type of tag.  allowed values are category, ticket, variation, board, contact, order, messenger, messageBillable
     *
     * @return $this
     */
     ...
     * @return $this
     */
    public function setRelationshipValue(int $relationship_value): static
    {
        if (is_null($relationship_value)) {
            throw new InvalidArgumentException('non-nullable relationship_value cannot be null');
        }
     ...
     *
     * @param string|null $relationship_uuid5 The ID of the data record for which a tag relationship is created. For models with uuid5 as primary key optional
     *
     * @return $this
     */
    public function setRelationshipUuid5(?string $relationship_uuid5): static
    {
        if (is_null($relationship_uuid5)) {
            throw new InvalidArgumentException('non-nullable relationship_uuid5 cannot be null');
        }
